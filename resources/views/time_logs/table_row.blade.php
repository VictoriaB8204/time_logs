<tr class="time_log_form">
    ...
    <td class="p-0">
        <input type="datetime-local" class="form-control w-13-em" id="start_time_date" name="start_time_date"
               value="{{ $timeLog->start_time_date ? $timeLog->start_time_date : '' }}"
        >
    </td>
    <td class="p-0">
        <input type="datetime-local" class="form-control w-13-em" id="end_time_date" name="end_time_date"
